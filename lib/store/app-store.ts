...
export const useAppStore = create<AppState>()(
  ...
  updateRequestStatus: (id, status) => set((state) => {
    ...
    // Auto-decrement inventory on completion (Naive string parsing for MVP)
    if (status === "Completed" && targetReq?.requestedResources) {
    ...
    return { requests: updated, activities: [newActivity, ...state.activities], inventory: updatedInventory };
  }),
